...
\begin{figure}[htbp]
   \centering
   \subfloat[][]{\includegraphics[width=.48\textwidth]{Ch4/Img/PtRec_AntiKt4EMTopoJets.pdf}}\quad
   \subfloat[][]{\includegraphics[width=.48\textwidth]{Ch4/Img/PtRec_AntiKt4EMPFlowJets.pdf}}
   \begin{tcolorbox}[colback=black!5!white,colframe=white!75!black]
