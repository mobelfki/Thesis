...
\begin{figure}[H]
    \centering
    \subfloat[][]{\includegraphics[width=.5\textwidth]{Ch4/Img/JVT.png}}
    \subfloat[][]{\includegraphics[width=.5\textwidth]{Ch4/Img/JVT_Eff.png}} 
...
\subsection{$p_T$Reco correction}
...
\begin{figure}[ht]
   \centering
   \subfloat[][]{\includegraphics[width=.48\textwidth]{Ch4/Img/ptrecotopo.png}}\quad
   \subfloat[][]{\includegraphics[width=.48\textwidth]{Ch4/Img/ptrecopflow.png}}
...
\begin{figure}[ht]
   \centering
   \subfloat[][]{\includegraphics[width=.48\textwidth]{Ch4/Img/E_AntiKt4EMTopoJets.png}}\quad
   \subfloat[][]{\includegraphics[width=.48\textwidth]{Ch4/Img/E_AntiKt4EMPFlowJets.png}}
...
\begin{figure}[ht]
   \centering
   \subfloat[][]{\includegraphics[width=.48\textwidth]{Ch4/Img/mbb_AntiKt4EMTopoJets.png}}\quad
   \subfloat[][]{\includegraphics[width=.48\textwidth]{Ch4/Img/mbb_AntiKt4EMPFlowJets.png}}
