...
\begin{figure}[ht]
   \centering
   \subfloat[][]{\includegraphics[width=.48\textwidth]{Ch4/mbb_AntiKt4EMTopoJets.png}}\quad
   \subfloat[][]{\includegraphics[width=.48\textwidth]{Ch4/mbb_AntiKt4EMPFlowJets.png}}
