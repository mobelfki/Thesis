...
\begin{figure}[htbp]
    ...
    \caption{Distributions of \myy in all signal categories. The simulated continuum background is scaled by the $\gamma\gamma$, $\gamma$-jet/jet-$\gamma$, and jet-jet fractions and normalized to the data side-band ($m_{\gamma\gamma} \in [105, 120] \cup [130, 160]$ GeV). The background decomposition is described in Section \ref{HHyybb:Modelling:Bkg}.}
