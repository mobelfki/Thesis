...
\subsection{Observed events and \texorpdfstring{\myy} fit}
...
\section{Comparison to 36 \texorpdfstring{\ifb} results}
\label{HHyybb:36ifb}
...
\section{Comparison to CMS \texorpdfstring{\HHyybb} results}
\label{HHyybb:CMS}
...
\subsection{\texorpdfstring{\bbbb} channel}
\label{HHyybb:HH:4b}
